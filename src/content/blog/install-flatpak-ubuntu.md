...
![Opening terminal with Ctrl+Alt+T shortcut](/media/blog/install-flatpak-ubuntu/images/01-open-terminal.png)
...
![Running sudo apt install flatpak command in terminal](/media/blog/install-flatpak-ubuntu/images/02-apt-install-flatpak.png)
...
![Adding flathub repository with flatpak remote-add command](/media/blog/install-flatpak-ubuntu/images/03-enable-flathub.png)
...
![Installing gnome-software-plugin-flatpak package](/media/blog/install-flatpak-ubuntu/images/04-plugin-install-start.png)
...
![Flathub repository error message in terminal](/media/blog/install-flatpak-ubuntu/images/06-error-message.png)
...
![Ksnip application installed via Flatpak running on Ubuntu](/media/blog/install-flatpak-ubuntu/images/07-ksnip-installed.png)
